...
public class UserSignupAcitivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_signup_acitivity);
        ...
        btn_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(UserSignupAcitivity.this, LoginActivity.class);
                startActivity(i);
                finish();
            }
        });
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(UserSignupAcitivity.this,"Dummy file uploaded !", Toast.LENGTH_SHORT).show();
            }
        });
